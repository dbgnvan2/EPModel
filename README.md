...
The v2 specification is **approved** — 419 numbered requirements over 16 modules, 33 acceptance criteria, at revision 6 (2026-08-28). **No code moves until the implementation plan is also approved**: the project's convention is spec → plan → build, each approved before the next. The plan is the next piece of work.
