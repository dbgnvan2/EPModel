...
> **`EPMODEL_BRIEF.md` was not preserved** (noted 2026-09-21). See the note in `SWEEP_READING_REPORTS_2026-09-20.md` under "How these were produced". This file's coverage statuses do not depend on it: each was re-checked against spec v2 directly, as described above.
